...
Status: Wave 11 is active. The 60-case personal-alpha corpus and local undeployed Site pass their scoped gates. The three benchmarks remain. R04 and R22 remain partial, and final plugin acceptance remains prohibited.
...
| R22 | Plan compliance | This ledger, traceability, receipts, CI | 204 tests on two CI Python versions at the Wave 10 baseline; 242 tests on both CI Python versions for the Wave 11 candidate | Wave 1 through Wave 10 receipts and public CI are present. The Wave 11 corpus, local Site, public CI, and private CI pass, but all three benchmarks and later final review remain open. | Partial |
...
- Local regression suite: 242 tests pass under Python 3.9.6.
- Independent technical browser review: Pass.
- Independent Unslop review: Pass after repair.
