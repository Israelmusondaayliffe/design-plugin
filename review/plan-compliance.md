...
| R22 | Plan compliance | This ledger, traceability, receipts, CI | 204 tests on two CI Python versions at the Wave 10 baseline; 242 local tests for the current Wave 11 candidate | Wave 1 through Wave 10 receipts and public CI are present. The Wave 11 corpus and local Site pass scoped review, but fresh public CI, all three benchmarks, and later final review remain open. | Partial |
